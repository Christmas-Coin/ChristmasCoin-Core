...
// christmascoin: on startup load spork values from previous session if they exist in the sporkDB
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // christmascoin: add to spork database.
...
int64_t GetSporkValue(int nSporkID)
{
	...
	if (nSporkID == SPORK_19_LAST_1500_COLLAT_BLOCK) r = SPORK_19_LAST_1500_COLLAT_BLOCK_DEFAULT;
...
bool CSporkManager::CheckSignature(CSporkMessage& spork)
{
    ...
    string strSporkKey = "042f5faa163b35f41011a96eede8a1d537eb7ae0b42c4daca331bed5608c31fcd5c2ace11d35739b770e2588e245bad62b9965ed41d28285f4adf6ddfae0c5905c";
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_16_ZEROCOIN_MAINTENANCE_MODE") return SPORK_16_ZEROCOIN_MAINTENANCE_MODE;
        ...
        if (strName == "SPORK_19_LAST_1500_COLLAT_BLOCK") return SPORK_19_LAST_1500_COLLAT_BLOCK;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_16_ZEROCOIN_MAINTENANCE_MODE) return "SPORK_16_ZEROCOIN_MAINTENANCE_MODE";
        ...
        if (id == SPORK_19_LAST_1500_COLLAT_BLOCK) return "SPORK_19_LAST_1500_COLLAT_BLOCK";
