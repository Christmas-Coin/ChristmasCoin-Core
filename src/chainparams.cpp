...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 23798;
        //bnProofOfWorkLimit = ~uint256(0) >> 1; // christmascoin starting difficulty is 1 / 2^12
        bnProofOfWorkLimit = ~uint256(0) >> 1; // Trittium starting difficulty is 1 / 2^20
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1* 60; // christmascoin: 1 day
        nTargetSpacing = 1 * 60; //christmascoin: 1 minute
        nMaturity = 60;
...
*/
        ...
        strSporkKey = "042f5faa163b35f41011a96eede8a1d537eb7ae0b42c4daca331bed5608c31fcd5c2ace11d35739b770e2588e245bad62b9965ed41d28285f4adf6ddfae0c5905c";
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
  //      vSeeds.push_back(CDNSSeedData("testnet.christmascoin.io", "testnet.christmascoin.io"));         // Single node address
//        vSeeds.push_back(CDNSSeedData("testnet1.christmascoin.io", "testnet1.christmascoin.io"));       // Single node address
    //    vSeeds.push_back(CDNSSeedData("testnet2.christmascoin.io", "testnet2.christmascoin.io"));       // Single node address
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // christmascoin: 1 day
        nTargetSpacing = 1 * 60;        // christmascoin: 1 minutes
