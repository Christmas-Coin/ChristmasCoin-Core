...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop christmascoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "christmascoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* christmascoin features */
        {"christmascoin", "masternode", &masternode, true, true, false},
        {"christmascoin", "listmasternodes", &listmasternodes, true, true, false},
        {"christmascoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"christmascoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"christmascoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"christmascoin", "masternodedebug", &masternodedebug, true, true, false},
        {"christmascoin", "startmasternode", &startmasternode, true, true, false},
        {"christmascoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"christmascoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"christmascoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"christmascoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"christmascoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"christmascoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"christmascoin", "mnbudget", &mnbudget, true, true, false},
        {"christmascoin", "preparebudget", &preparebudget, true, true, false},
        {"christmascoin", "submitbudget", &submitbudget, true, true, false},
        {"christmascoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"christmascoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"christmascoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"christmascoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"christmascoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"christmascoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"christmascoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"christmascoin", "checkbudgets", &checkbudgets, true, true, false},
        {"christmascoin", "mnsync", &mnsync, true, true, false},
        {"christmascoin", "spork", &spork, true, true, false},
        {"christmascoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"christmascoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use christmascoind, or the -server option to christmascoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> christmascoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:23799/\n";
}
