...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("christmascoin Core christmascoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  christmascoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded christmascoin transaction") + "\n" +
                               "  christmascoin-tx [options] -create [commands]   " + _("Create hex-encoded christmascoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded christmascoin transaction
