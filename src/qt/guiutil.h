...
/** Utility functions used by the christmascoin Qt UI.
 */
namespace GUIUtil
{
...
// Render christmascoin addresses in monospace font
...
// Parse "christmascoin:" URI into recipient object, return true on successful parsing
