...
public:
    ...
    void setZchristmascoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzCHMC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzCHMC_clicked();
    void on_pushButtonZchristmascoinControl_clicked();
