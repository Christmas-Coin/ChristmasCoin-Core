                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    GUIUtil::restoreWindowGeometry("nWindow", QSize(930, 550), this);

    QString windowTitle = tr("Christmascoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a christmascoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and christmascoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCHMC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About christmascoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about christmascoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for christmascoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your christmascoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified christmascoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a christmascoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the christmascoin Core help message to get a list with possible christmascoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("christmascoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to christmascoin network", "", count));
}
...
{
    QString strTitle = tr("christmascoin Core"); // default title
