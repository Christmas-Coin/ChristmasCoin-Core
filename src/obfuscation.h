...
{
public:
    /// Is the inputs associated with this public key? (and there is 50000 CHMC - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of christmascoin.
