/* src/config/christmascoin-config.h.  Generated from christmascoin-config.h.in by configure.  */
/* src/config/christmascoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef christmascoin_CONFIG_H

#define christmascoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.christmascoin.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "christmascoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "christmascoin Core 2.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "christmascoin"
