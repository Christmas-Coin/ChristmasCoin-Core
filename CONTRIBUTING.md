Contributing to christmascoin Core
============================

The christmascoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the christmascoin Core project, and is not to be
confused with overall christmascoin Network Protocol consensus changes.

Whether a pull request is merged into christmascoin Core rests with the project merge
...
Patches that change christmascoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the christmascoin consensus, it must have been
...
The project leader is the release manager for each christmascoin Core release.
