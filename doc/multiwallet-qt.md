...
In order to support loading of multiple wallets in christmascoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is christmascoin.cpp.
...
Changes to christmascoin.cpp
----------------------
christmascoin.cpp is the entry point into christmascoin-qt, and as such, will require some minor modifications to provide hooks for
